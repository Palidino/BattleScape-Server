...
import com.palidinodh.osrsscript.player.plugin.clanwars.ClanWarsRule;
import com.palidinodh.osrsscript.player.plugin.clanwars.ClanWarsRuleOption;
...
public class Mode {
  ...
  static {
    ...
    mode.rules(buildRules(ClanWarsRule.PRAYER, ClanWarsRuleOption.NO_OVERHEADS,
    ...
    mode.rules(buildRules(ClanWarsRule.SPECIAL_ATTACKS, ClanWarsRuleOption.NO_STAFF_OF_THE_DEAD));
    mode.attackLevel(99).strengthLevel(99).rangedLevel(99).magicLevel(99).defenceLevel(99)
        .hitpointsLevel(99).prayerLevel(99);
    mode.rune(ItemId.DEATH_RUNE).rune(ItemId.BLOOD_RUNE).rune(ItemId.WATER_RUNE);
    mode.loadout(new Loadout.Entry("Load-out",
    ...
    mode.loadout(new Loadout.Entry("Load-out #2",
        new Item[] { new Item(ItemId.BERSERKER_HELM), new Item(ItemId.INFERNAL_CAPE),
            ...
            new Item(ItemId.RUNE_BOOTS), null, new Item(ItemId.BERSERKER_RING_I), null },
        new Item[] { null, new Item(ItemId.RANGING_POTION_4),
            new Item(ItemId.SUPER_COMBAT_POTION_4), new Item(ItemId.SARADOMIN_BREW_4),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
            new Item(ItemId.SANFEW_SERUM_4), new Item(ItemId.SARADOMIN_BREW_4),
            new Item(ItemId.ANGLERFISH), new Item(ItemId.ANGLERFISH),
    ...
    mode.rules(buildRules(ClanWarsRule.PRAYER, ClanWarsRuleOption.NO_OVERHEADS,
        ClanWarsRule.IGNORE_FREEZING, ClanWarsRuleOption.ALLOWED));
    ...
    mode.rules(buildRules(ClanWarsRule.PRAYER, ClanWarsRuleOption.DISABLED,
        ClanWarsRule.SPECIAL_ATTACKS, ClanWarsRuleOption.DISABLED, ClanWarsRule.FOOD,
        ClanWarsRuleOption.DISABLED, ClanWarsRule.DRINKS, ClanWarsRuleOption.DISABLED));
    mode.attackLevel(99).strengthLevel(99).rangedLevel(99).magicLevel(99).defenceLevel(99)
        .hitpointsLevel(99).prayerLevel(99);
    mode.loadout(new Loadout.Entry("Load-out",
