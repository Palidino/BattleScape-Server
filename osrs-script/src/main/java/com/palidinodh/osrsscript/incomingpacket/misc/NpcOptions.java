...
public class NpcOptions {
  // Piles
  public static void npc13(Player player, int option, Npc npc) {
    player.getGameEncoder().sendMessage("Use items on Piles to note them.");
  }

  // Adam
  public static void npc311(Player player, int option, Npc npc) {
    if (option == 0) {
  ...
  // Sarah
  public static void npc501(Player player, int option, Npc npc) {
    player.openShop("skilling");
  }

  // Shop keeper
  public static void npc506(Player player, int option, Npc npc) {
    player.openShop("equipment");
  }

  // Oziach
  public static void npc822(Player player, int option, Npc npc) {
    player.openShop("skill_exchange");
  }

  // Monk of Entrana
  public static void npc1166(Player player, int option, Npc npc) {
  ...
  // Monk of Entrana
  public static void npc1167(Player player, int option, Npc npc) {
    for (int i = 0; i < player.getInventory().size(); i++) {
      int itemId = player.getInventory().getId(i);
      if (itemId == -1 || ItemDef.getEquipSlot(itemId) == null) {
        continue;
  ...
  // Hunting expert
  public static void npc1504(Player player, int option, Npc npc) {
  ...
  // Gundai
  public static void npc1600(Player player, int option, Npc npc) {
    player.getBank().open();
  }

  // Lundail
  public static void npc1601(Player player, int option, Npc npc) {
    if (option == 2) {
  ...
  // Kolodion
  public static void npc1603(Player player, int option, Npc npc) {
    player.openDialogue("kolodion", 0);
  }

  // Baby impling
  public static void npc1635(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Young impling
  public static void npc1636(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Gourmet impling
  public static void npc1637(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Earth impling
  public static void npc1638(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Essence impling
  public static void npc1639(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Eclectic impling
  public static void npc1640(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Nature impling
  public static void npc1641(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Magpie impling
  public static void npc1642(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Ninja impling
  public static void npc1643(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Dragon impling
  public static void npc1644(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Baby impling
  public static void npc1645(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Young impling
  public static void npc1646(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Gourmet impling
  public static void npc1647(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Earth impling
  public static void npc1648(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Essence impling
  public static void npc1649(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Eclectic impling
  public static void npc1650(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Nature impling
  public static void npc1651(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Magpie impling
  public static void npc1652(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Ninja impling
  public static void npc1653(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Dragon impling
  public static void npc1654(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Void Knight
  public static void npc1755(Player player, int option, Npc npc) {
    player.openShop("pest_control");
  }

  // Squire
  public static void npc1763(Player player, int option, Npc npc) {
    if (option == 0) {
  ...
  // Squire
  public static void npc1764(Player player, int option, Npc npc) {
    if (option == 0) {
      player.openDialogue("bank", 1);
    } else if (option == 2) {
      player.getBank().open();
  ...
  // Squire
  public static void npc1765(Player player, int option, Npc npc) {
    player.openShop("equipment");
  }

  // Squire
  public static void npc1766(Player player, int option, Npc npc) {
    player.openShop("equipment");
  }

  // Squire
  public static void npc1767(Player player, int option, Npc npc) {
    player.openShop("equipment");
  }

  // Squire
  public static void npc1768(Player player, int option, Npc npc) {
    player.openShop("equipment");
  }

  // Squire
  public static void npc1769(Player player, int option, Npc npc) {
  ...
  public static void npc2148(Player player, int option, Npc npc) {
    if (option == 0) {
  ...
  // Grand Exchange Clerk
  public static void npc2149(Player player, int option, Npc npc) {
    if (option == 0) {
      player.openDialogue("grandexchange", 0);
    } else if (option == 2) {
      player.getGrandExchange().open();
  ...
  // TzHaar-Mej-Jal
  public static void npc2180(Player player, int option, Npc npc) {
    player.openDialogue("tzhaar", 1);
  }

  // TzHaar-Ket-Zuh
  public static void npc2182(Player player, int option, Npc npc) {
    player.getBank().open();
  }

  // TzHaar-Hur-Tel
  public static void npc2183(Player player, int option, Npc npc) {
    player.openShop("tzhaar_equipment");
  }

  // TzHaar-Hur-Lek
  public static void npc2184(Player player, int option, Npc npc) {
    player.openShop("tzhaar_rocks");
  }

  // TzHaar-Mej-Roh
  public static void npc2185(Player player, int option, Npc npc) {
    player.openShop("tzhaar_runes");
  }

  // Richard
  public static void npc2200(Player player, int option, Npc npc) {
    player.openShop("teamcapes");
  }

  // Lidio
  public static void npc2469(Player player, int option, Npc npc) {
    player.openShop("warriors_guild_food");
  }

  // Lilly
  public static void npc2470(Player player, int option, Npc npc) {
    player.openShop("warriors_guild_potions");
  }

  // Anton
  public static void npc2471(Player player, int option, Npc npc) {
    player.openShop("warriors_guild_armour");
  }
  /* 2560 - 2815 */

  // Mage of Zamorak
  public static void npc2581(Player player, int option, Npc npc) {
  ...
  // Dantaera
  public static void npc2664(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Kragen
  public static void npc2665(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Lyra
  public static void npc2666(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Francis
  public static void npc2667(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Garth
  public static void npc2669(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Ellena
  public static void npc2670(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Selena
  public static void npc2671(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Vasquen
  public static void npc2672(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Rhonen
  public static void npc2673(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Dreven
  public static void npc2674(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Taria
  public static void npc2675(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Rhazien
  public static void npc2676(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Torrell
  public static void npc2677(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Alain
  public static void npc2678(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Heskel
  public static void npc2679(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Treznor
  public static void npc2680(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Fayeth
  public static void npc2681(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Bolongo
  public static void npc2682(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Gileth
  public static void npc2683(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Frizzy Skernip
  public static void npc2684(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Yulf Squecks
  public static void npc2685(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Praistan Ebola
  public static void npc2686(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Prissy Scilla
  public static void npc2687(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Imiago
  public static void npc2688(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Liliwen
  public static void npc2689(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Martin Thwait
  public static void npc3193(Player player, int option, Npc npc) {
  ...
  public static void npc3619(Player player, int option, Npc npc) {
  ...
  // Ungadulu
  public static void npc3957(Player player, int option, Npc npc) {
  ...
  // Siegfried Erkle
  public static void npc3961(Player player, int option, Npc npc) {
    player.openShop("legends");
  }

  // Boulder
  public static void npc3967(Player player, int option, Npc npc) {
  ...
  // Ilfeen
  public static void npc4003(Player player, int option, Npc npc) {
    player.openDialogue("elfseed", 0);
  }

  // Fisherman
  public static void npc4065(Player player, int option, Npc npc) {
    player.openDialogue("fishnoter", 0);
  }

  // Wizard
  public static void npc4399(Player player, int option, Npc npc) {
    if (option == 0) {
  ...
  // Sir Vyvin
  public static void npc4736(Player player, int option, Npc npc) {
    player.openShop("white_knight");
  }

  // Miles
  public static void npc5437(Player player, int option, Npc npc) {
    for (int i = 0; i < player.getInventory().size(); i++) {
      int itemId = player.getInventory().getId(i);
  ...
  // Security Guard
  public static void npc5442(Player player, int option, Npc npc) {
    player.getInventory().addOrDropItem(9003, 1);
  }

  // Le-sabr￨
  public static void npc5521(Player player, int option, Npc npc) {}

  // Black warlock
  public static void npc5553(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Snowy knight
  public static void npc5554(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Sapphire glacialis
  public static void npc5555(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Ruby harvest
  public static void npc5556(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Elnock Inquisitor
  public static void npc5734(Player player, int option, Npc npc) {
    player.openShop("skilling");
  }

  // <col=00ffff>Boulder</col>
  public static void npc6621(Player player, int option, Npc npc) {
  ...
  // Marisi
  public static void npc6921(Player player, int option, Npc npc) {
    if (option == 0) {
      player.getGameEncoder().sendMessage("This gardener will protect your patches for a fee.");
    } else {
      player.getFarming().gardenerProtection(npc, option - 2);
  ...
  // Tynan
  public static void npc6964(Player player, int option, Npc npc) {
    player.openShop("skilling");
  }

  // Tyss
  public static void npc7050(Player player, int option, Npc npc) {
    if (option == 0) {
  ...
  // Lucky impling
  public static void npc7233(Player player, int option, Npc npc) {
    player.getHunter().catchNPC(npc);
  }

  // Perry
  public static void npc7240(Player player, int option, Npc npc) {
    player.openShop("skilling");
  }

  // Eniola
  public static void npc7417(Player player, int option, Npc npc) {
    player.getBank().open();
  }

  // TzHaar-Ket-Zuh
  public static void npc7677(Player player, int option, Npc npc) {
    if (option == 0) {
      player.openDialogue("bank", 1);
    } else if (option == 2) {
      player.getBank().open();
  ...
  // TzHaar-Ket-Keh
  public static void npc7690(Player player, int option, Npc npc) {
    player.openDialogue("tzhaar", 6);
  }

  // Gadrin
  public static void npc7716(Player player, int option, Npc npc) {
  ...
  // Belona
  public static void npc7719(Player player, int option, Npc npc) {
    if (option == 3) {
  ...
  // Kylie Minnow
  public static void npc7728(Player player, int option, Npc npc) {
    player.openShop("minnows");
  }
  /* 7936 - 8191 */

  // Emblem Trader
  public static void npc7942(Player player, int option, Npc npc) {
    if (option == 0) {
  ...
  // Elder Chaos druid
  public static void npc7995(Player player, int option, Npc npc) {
    player.getGameEncoder().sendMessage("The elder chaos druid will unnote bones for a fee.");
  }

  // Vorkath
  public static void npc8059(Player player, int option, Npc npc) {
    if (npc.isLocked()) {
      return;
    }
  ...
  public static void npc16002(Player player, int option, Npc npc) {
  ...
  public static void npc16003(Player player, int option, Npc npc) {
    if (!player.getInventory().hasItem(ItemId.HAMMER)
        && player.getEquipment().getWeaponId() != ItemId.DRAGON_WARHAMMER
        && player.getEquipment().getWeaponId() != ItemId.ELDER_MAUL
        && player.getEquipment().getWeaponId() != ItemId.TORAGS_HAMMERS) {
  ...
  public static void npc16004(Player player, int option, Npc npc) {
    if (!player.getInventory().hasItem(ItemId.HAMMER)
        && player.getEquipment().getWeaponId() != ItemId.DRAGON_WARHAMMER
        && player.getEquipment().getWeaponId() != ItemId.ELDER_MAUL
        && player.getEquipment().getWeaponId() != ItemId.TORAGS_HAMMERS) {
