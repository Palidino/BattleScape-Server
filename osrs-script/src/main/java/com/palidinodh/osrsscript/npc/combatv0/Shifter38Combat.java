...
public class Shifter38Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.SHIFTER_38);
    combat.spawn(NpcCombatSpawn.builder().respawnDelay(100).build());
    combat.hitpoints(NpcCombatHitpoints.total(46));
    combat.stats(NpcCombatStats.builder().attackLevel(38).defenceLevel(19).build());
