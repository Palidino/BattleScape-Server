...
public class KetZek360Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.KET_ZEK_360);
    combat.hitpoints(NpcCombatHitpoints.total(160));
    combat.stats(NpcCombatStats.builder().attackLevel(320).magicLevel(240).rangedLevel(480)
        .defenceLevel(240).bonus(CombatBonus.ATTACK_MAGIC, 60).build());
