...
public class Ravager53Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.RAVAGER_53);
    combat.spawn(NpcCombatSpawn.builder().respawnDelay(100).build());
    combat.hitpoints(NpcCombatHitpoints.total(76));
    combat.stats(NpcCombatStats.builder().attackLevel(26).defenceLevel(26).build());
