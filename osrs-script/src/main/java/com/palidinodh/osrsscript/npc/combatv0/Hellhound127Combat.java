...
public class Hellhound127Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.id(NpcId.HELLHOUND_127);
    combat.hitpoints(NpcCombatHitpoints.total(116));
    combat.stats(NpcCombatStats.builder().attackLevel(107).defenceLevel(106).build());
    combat.aggression(NpcCombatAggression.PLAYERS);
    combat.combatScript("ZamorakGWDCS").deathAnimation(6576).blockAnimation(6578);
