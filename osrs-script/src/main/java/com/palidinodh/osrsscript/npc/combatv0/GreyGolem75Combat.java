...
public class GreyGolem75Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.GREY_GOLEM_75);
    combat.hitpoints(NpcCombatHitpoints.total(80));
    combat.stats(NpcCombatStats.builder().attackLevel(80).defenceLevel(80)
        .bonus(CombatBonus.DEFENCE_STAB, 300).bonus(CombatBonus.DEFENCE_SLASH, 1)
        .bonus(CombatBonus.DEFENCE_CRUSH, 300).bonus(CombatBonus.DEFENCE_MAGIC, 300)
