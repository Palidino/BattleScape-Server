...
public class FlightKilisa159Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.spawn(NpcCombatSpawn.builder().respawnDelay(50).respawnWithId(NpcId.KREEARRA_580)
        .respawnWithId(NpcId.WINGMAN_SKREE_143).respawnWithId(NpcId.FLOCKLEADER_GEERIN_149)
        .build());
    combat.hitpoints(NpcCombatHitpoints.total(159));
    combat.stats(NpcCombatStats.builder().attackLevel(124).magicLevel(50).rangedLevel(169)
        .defenceLevel(175).build());
