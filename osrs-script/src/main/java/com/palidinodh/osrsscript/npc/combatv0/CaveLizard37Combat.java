...
public class CaveLizard37Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.stats(NpcCombatStats.builder().attackLevel(38).defenceLevel(35)
        .bonus(CombatBonus.DEFENCE_STAB, 5).bonus(CombatBonus.DEFENCE_SLASH, 15)
        .bonus(CombatBonus.DEFENCE_CRUSH, 15).bonus(CombatBonus.DEFENCE_RANGED, 15).build());
    ...
    style.animation(3855).attackSpeed(4);
