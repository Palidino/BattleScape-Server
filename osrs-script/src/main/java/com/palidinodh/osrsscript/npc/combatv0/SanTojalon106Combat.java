...
class SanTojalon106Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.stats(NpcCombatStats.builder().attackLevel(86).defenceLevel(86)
        .bonus(CombatBonus.MELEE_ATTACK, 16).bonus(CombatBonus.DEFENCE_STAB, 18)
        .bonus(CombatBonus.DEFENCE_SLASH, 22).bonus(CombatBonus.DEFENCE_CRUSH, 20)
