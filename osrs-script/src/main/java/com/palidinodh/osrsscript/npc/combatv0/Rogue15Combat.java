...
public class Rogue15Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.stats(NpcCombatStats.builder().attackLevel(13).defenceLevel(13)
        .bonus(CombatBonus.MELEE_ATTACK, 5).bonus(CombatBonus.DEFENCE_STAB, 6)
        .bonus(CombatBonus.DEFENCE_SLASH, 9).bonus(CombatBonus.DEFENCE_CRUSH, 11).build());
