...
public class VetionReborn454Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.id(NpcId.VETION_REBORN_454);
    ...
    combat.killCount(NpcCombatKillCount.builder().asName("Vet'ion").sendMessage(true).build());
    combat.combatScript("VetionCS").type(NpcCombatType.UNDEAD).deathAnimation(5509)
        .blockAnimation(5508);
