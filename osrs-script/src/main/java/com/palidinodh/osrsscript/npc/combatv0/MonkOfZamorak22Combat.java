...
public class MonkOfZamorak22Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.id(NpcId.MONK_OF_ZAMORAK_22);
    combat.hitpoints(NpcCombatHitpoints.total(25));
    combat.stats(NpcCombatStats.builder().attackLevel(8).magicLevel(25).defenceLevel(12).build());
