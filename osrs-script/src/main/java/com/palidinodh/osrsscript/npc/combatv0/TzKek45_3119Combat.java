...
public class TzKek45_3119Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.TZ_KEK_45_3119);
    combat.hitpoints(NpcCombatHitpoints.total(20));
    combat.stats(NpcCombatStats.builder().attackLevel(40).magicLevel(60).rangedLevel(30)
        .defenceLevel(30).build());
