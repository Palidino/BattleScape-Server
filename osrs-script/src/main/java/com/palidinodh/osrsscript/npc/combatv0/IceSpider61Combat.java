...
public class IceSpider61Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.ICE_SPIDER_61);
    combat.hitpoints(NpcCombatHitpoints.total(65));
    combat.stats(NpcCombatStats.builder().attackLevel(50).defenceLevel(43)
        .bonus(CombatBonus.DEFENCE_STAB, 20).bonus(CombatBonus.DEFENCE_SLASH, 17)
        .bonus(CombatBonus.DEFENCE_CRUSH, 12).bonus(CombatBonus.DEFENCE_MAGIC, 13)
