...
public class IrvigSenay100Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var drop = NpcCombatDrop.builder();
    var dropTable = NpcCombatDropTable.builder().chance(NpcCombatDropTable.CHANCE_ALWAYS);
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.HUNK_OF_CRYSTAL)));
    ...
    combat.stats(NpcCombatStats.builder().attackLevel(76).defenceLevel(81)
        .bonus(CombatBonus.MELEE_ATTACK, 29).bonus(CombatBonus.DEFENCE_STAB, 27)
        .bonus(CombatBonus.DEFENCE_SLASH, 31).bonus(CombatBonus.DEFENCE_CRUSH, 29)
        .bonus(CombatBonus.DEFENCE_RANGED, 29).build());
