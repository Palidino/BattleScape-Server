...
public class CrawlingHand12Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.id(NpcId.CRAWLING_HAND_12);
    combat.hitpoints(NpcCombatHitpoints.total(19));
    combat.stats(NpcCombatStats.builder().attackLevel(11).defenceLevel(7).build());
