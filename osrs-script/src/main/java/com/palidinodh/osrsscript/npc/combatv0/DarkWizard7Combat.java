...
public class DarkWizard7Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.id(NpcId.DARK_WIZARD_7);
    combat.hitpoints(NpcCombatHitpoints.total(12));
    combat.stats(NpcCombatStats.builder().magicLevel(6).defenceLevel(5)
        .bonus(CombatBonus.DEFENCE_MAGIC, 3).build());
    ...
    style.castGraphic(new Graphic(93, 92)).targetGraphic(new Graphic(95, 124));
