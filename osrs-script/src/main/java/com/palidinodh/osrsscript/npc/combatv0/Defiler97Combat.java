...
public class Defiler97Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.DEFILER_97);
    combat.spawn(NpcCombatSpawn.builder().respawnDelay(100).build());
    combat.hitpoints(NpcCombatHitpoints.total(194));
    combat.stats(NpcCombatStats.builder().rangedLevel(97).defenceLevel(48).build());
