...
public class DeadlyRedSpider34Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.stats(NpcCombatStats.builder().attackLevel(30).defenceLevel(30)
        .bonus(CombatBonus.DEFENCE_STAB, 15).bonus(CombatBonus.DEFENCE_SLASH, 16)
        .bonus(CombatBonus.DEFENCE_CRUSH, 7).bonus(CombatBonus.DEFENCE_MAGIC, 12)
        .bonus(CombatBonus.DEFENCE_RANGED, 16).build());
