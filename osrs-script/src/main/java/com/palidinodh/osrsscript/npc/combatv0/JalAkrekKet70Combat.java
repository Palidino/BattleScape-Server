...
public class JalAkrekKet70Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.JAL_AKREK_KET_70);
    combat.hitpoints(NpcCombatHitpoints.total(15));
    combat.stats(NpcCombatStats.builder().attackLevel(120).defenceLevel(95)
        .bonus(CombatBonus.ATTACK_STAB, 25).bonus(CombatBonus.ATTACK_SLASH, 25)
        .bonus(CombatBonus.ATTACK_CRUSH, 25).bonus(CombatBonus.MELEE_DEFENCE, 25).build());
