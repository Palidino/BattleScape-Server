...
public class ReanimatedDemonSpawn87Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var combat = NpcCombatDefinition.builder();
    combat.id(NpcId.REANIMATED_DEMON_SPAWN_87);
    combat.hitpoints(NpcCombatHitpoints.total(85));
    combat.stats(NpcCombatStats.builder().attackLevel(80).defenceLevel(71).build());
