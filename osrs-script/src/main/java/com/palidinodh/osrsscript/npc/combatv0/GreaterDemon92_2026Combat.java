...
public class GreaterDemon92_2026Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.FIRE_RUNE, 30, 60)));
    ...
    combat.id(NpcId.GREATER_DEMON_92_2026);
    combat.hitpoints(NpcCombatHitpoints.total(79));
    combat.stats(NpcCombatStats.builder().attackLevel(68).defenceLevel(71)
