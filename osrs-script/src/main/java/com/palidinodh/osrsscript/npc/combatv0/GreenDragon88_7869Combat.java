...
public class GreenDragon88_7869Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.ADAMANT_SWORD)));
    ...
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.MITHRIL_ORE, 2)));
    ...
    combat.id(NpcId.GREEN_DRAGON_88_7869);
