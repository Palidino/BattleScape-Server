...
public class MountainTroll69Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    var drop = NpcCombatDrop.builder().rareDropTableRate(NpcCombatDropTable.CHANCE_1_IN_256);
    var dropTable = NpcCombatDropTable.builder().chance(2.2);
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.ENSOULED_TROLL_HEAD_13484)));
    ...
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.STEEL_WARHAMMER)));
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.BLACK_WARHAMMER)));
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.NATURE_RUNE, 7)));
    ...
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.COAL, 3)));
    dropTable.drop(NpcCombatDropTableDrop.items(new RandomItem(ItemId.RAW_MACKEREL, 3)));
    drop.table(dropTable.build());
    ...
    style.animation(284).attackSpeed(6);
