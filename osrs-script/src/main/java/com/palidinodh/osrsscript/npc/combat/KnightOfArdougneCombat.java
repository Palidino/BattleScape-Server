...
public class KnightOfArdougneCombat extends NpcCombat {
  ...
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.stats(NpcCombatStats.builder().attackLevel(38).defenceLevel(41)
        .bonus(CombatBonus.MELEE_ATTACK, 8).bonus(CombatBonus.DEFENCE_STAB, 39)
        .bonus(CombatBonus.DEFENCE_SLASH, 40).bonus(CombatBonus.DEFENCE_CRUSH, 36)
        .bonus(CombatBonus.DEFENCE_MAGIC, -11).bonus(CombatBonus.DEFENCE_RANGED, 36).build());
