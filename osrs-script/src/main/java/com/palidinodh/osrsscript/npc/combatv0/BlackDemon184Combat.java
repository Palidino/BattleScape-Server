...
public class BlackDemon184Combat extends NpcCombat {
  @Override
  public List<NpcCombatDefinition> getCombatDefinitions() {
    ...
    combat.id(NpcId.BLACK_DEMON_184);
    combat.hitpoints(NpcCombatHitpoints.total(157));
    combat.stats(NpcCombatStats.builder().attackLevel(145).defenceLevel(148).build());
